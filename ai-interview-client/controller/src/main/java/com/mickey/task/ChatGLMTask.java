...
import com.mickey.GLM.ChatGLMModel;
import com.mickey.GLM.EventType;
import com.mickey.GLM.GLMResponseV3;
import com.mickey.service.interview.InterviewRecordService;
import com.mickey.service.interview.JobService;
import com.mickey.utils.GLMTokenUtils;
...
//        System.out.println(submitAnswerBO);
        ...
        RealEventSource realEventSource = getRealEventSource(
                content,
                submitAnswerDTO.getCandidateId(),
                job.getJobName(),
                submitAnswerDTO.getTotalSeconds(),
                request);
